\hypertarget{a00043}{}\doxysection{xroad\+\_\+functions Namespace Reference}
\label{a00043}\index{xroad\_functions@{xroad\_functions}}


Functions in this file are primarily focused on the solution of input data normalisation (getting input G\+N\+SS data enriched by the O\+SM format).  


\doxysubsection*{Functions}
\begin{DoxyCompactItemize}
\item 
def \mbox{\hyperlink{a00043_aaf2e496eb93301bf0e1868bb13ffcf0d}{feats}} (basedata)
\item 
def \mbox{\hyperlink{a00043_ab1fa15f670f4584a95d024ebd033f4e2}{coords}} (basedata\+\_\+features)
\item 
def \mbox{\hyperlink{a00043_a8cd499476af8ac8093199182c12aa66a}{del\+\_\+special\+\_\+elem}} (basedata)
\item 
def \mbox{\hyperlink{a00043_a8fe233efab2fe37396953b610d8843e5}{del\+\_\+unique\+\_\+nodes}} (basedata, uniq\+\_\+nodes)
...
def \mbox{\hyperlink{a00043_abe618c1d5ef312d9f560a4dfb19babae}{del\+\_\+special\+\_\+elem2}} (clist)
...
def \mbox{\hyperlink{a00043_a0da6741755a56847f493b95138dbb9c1}{del\+\_\+duplicates}} (alist)
\begin{DoxyCompactList}\small\item\em Function gets rid or duplicates in the input list not regarding its position (whether it is sequential duplicate). \end{DoxyCompactList}\item 
def \mbox{\hyperlink{a00043_a425167050a54c75b546ea988c0abf8a7}{coords\+\_\+to\+\_\+latlon}} (\mbox{\hyperlink{a00043_ab1fa15f670f4584a95d024ebd033f4e2}{coords}}, empty\+\_\+lat, empty\+\_\+lon)
...
def \mbox{\hyperlink{a00043_ac0dbe5d7798f5cc1fd46f93394709b31}{cut\+\_\+unnecessary\+\_\+xroads}} (nodes, chosen)
...
def \mbox{\hyperlink{a00043_a7d6462b11ff7bd6cdd0bf7946c49e682}{filter\+\_\+base}} (basedata, chosen\+\_\+nodes)
...
def \mbox{\hyperlink{a00043_a4aead3b3c74be0ce28bbe1a313350475}{get\+\_\+unique\+\_\+nodes}} (nodes)
\begin{DoxyCompactList}\small\item\em Function takes one list of nodes. \end{DoxyCompactList}\item 
def \mbox{\hyperlink{a00043_a5b40dc8bce309d77c6c2b8fe9206ccfc}{get\+\_\+fine\+\_\+indata}} (basedata, chosen\+\_\+nodes)
...
def \mbox{\hyperlink{a00043_afee3b9b1772ff6b27499f0e227dd3c73}{get\+\_\+nodes\+\_\+duplicates}} (\mbox{\hyperlink{a00043_ab1fa15f670f4584a95d024ebd033f4e2}{coords}}, nodes, smxd, nmxd, slcd)
...
\mbox{\Hypertarget{a00043_ab1fa15f670f4584a95d024ebd033f4e2}\label{a00043_ab1fa15f670f4584a95d024ebd033f4e2}} 
...
\mbox{\Hypertarget{a00043_a425167050a54c75b546ea988c0abf8a7}\label{a00043_a425167050a54c75b546ea988c0abf8a7}} 
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{a00043_ac0dbe5d7798f5cc1fd46f93394709b31}\label{a00043_ac0dbe5d7798f5cc1fd46f93394709b31}} 
...
If an element from nodes is not equal to any chosen of the chosen nodes, them it is marked by \mbox{[}-\/1, -\/1\mbox{]} which indicates that it will be deleted. As soon as it finds the equality, the process continues from the other side of the nodes list and the former process is immediately stopped.
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{a00043_a0da6741755a56847f493b95138dbb9c1}\label{a00043_a0da6741755a56847f493b95138dbb9c1}} 
...
\mbox{\Hypertarget{a00043_a8cd499476af8ac8093199182c12aa66a}\label{a00043_a8cd499476af8ac8093199182c12aa66a}} 
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{a00043_abe618c1d5ef312d9f560a4dfb19babae}\label{a00043_abe618c1d5ef312d9f560a4dfb19babae}} 
...
In this case\+: \mbox{[}-\/1,-\/1\mbox{]} \mbox{\Hypertarget{a00043_a8fe233efab2fe37396953b610d8843e5}\label{a00043_a8fe233efab2fe37396953b610d8843e5}} 
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{a00043_aaf2e496eb93301bf0e1868bb13ffcf0d}\label{a00043_aaf2e496eb93301bf0e1868bb13ffcf0d}} 
...
\mbox{\Hypertarget{a00043_a7d6462b11ff7bd6cdd0bf7946c49e682}\label{a00043_a7d6462b11ff7bd6cdd0bf7946c49e682}} 
...
\begin{DoxyParams}{Parameters}
{\em basedata} & type dictionary and has to satisfy used case-\/specific geojson format \\
\hline
{\em chosen\+\_\+nodes} & list of nodes which we want in the basemap and all other we want deleted \\
\hline
\end{DoxyParams}
\mbox{\Hypertarget{a00043_a5b40dc8bce309d77c6c2b8fe9206ccfc}\label{a00043_a5b40dc8bce309d77c6c2b8fe9206ccfc}} 
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{a00043_afee3b9b1772ff6b27499f0e227dd3c73}\label{a00043_afee3b9b1772ff6b27499f0e227dd3c73}} 
...
\begin{DoxyParams}{Parameters}
{\em coords} & list of input data nodes 
\begin{DoxyCode}{1}
\DoxyCodeLine{             [[lon1,lat1],[lon2,lat2],...]}
\DoxyCodeLine{@param     nodes   nodes of \textcolor{stringliteral}{"{}basemap"{}}}
\DoxyCodeLine{@param     smxd    Slow Movement Crossroad Distance}
\end{DoxyCode}
 testing the distance between xroad node and a coordinate while the distance between current and the previous coordinate is smaller than the \char`\"{}last\+Coordinate\+Distance\char`\"{} \\
\hline
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{a00043_a4aead3b3c74be0ce28bbe1a313350475}\label{a00043_a4aead3b3c74be0ce28bbe1a313350475}} 
